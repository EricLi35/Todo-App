...
//
//
//        JButton hireButton = new JButton(addTask);
//        HireListener hireListener = new HireListener(hireButton);
//        hireButton.setActionCommand(addTask);
//        hireButton.addActionListener(hireListener);
//        hireButton.setEnabled(false);
//
//
//
//        fireButton = new JButton(removeTask);
//        fireButton.setActionCommand(removeTask);
